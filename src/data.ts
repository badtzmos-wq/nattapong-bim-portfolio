...
export const projects: Project[] = [
  ...
  {
    id: "semi-automated-dashboard",
    number: "15",
    title: "Semi-Automated Dashboard",
    year: "2026-Present",
    category: "BIM Coordination & Management",
    type: "BIM Automation / Dashboard Workflow",
    role: "BIM Specialist / Solution Development",
    tools: ["Power Automate", "Power BI", "Microsoft Teams", "Excel"],
    description: "Semi-automated dashboard workflow using Power Automate, Teams, and Power BI to trigger progress updates and reduce manual reporting steps.",
    concept: "Use Power Automate flows and Teams-based update commands to refresh dashboard information, notify project users, and provide a direct dashboard access workflow for BIM progress reporting.",
    keyOutputs: ["Power Automate update flow", "Teams update trigger", "Dashboard access link", "Power BI progress dashboard", "Reduced manual reporting steps"],
    image: media("semi-automated-dashboard.png"),
    gallery: [media("semi-automated-dashboard.png")],
  },
  {
